...
| [`/split-and-ship`](skills/split-and-ship/SKILL.md) | Ship split plan as separate branches and PRs or sequential commits on the current branch | [`/commit-staged-push`](skills/commit-staged-push/SKILL.md), [`/create-pr`](skills/create-pr/SKILL.md), [`/update-pr`](skills/update-pr/SKILL.md) |
